 ...
 */
 ...
 // 以下２行、日付の数字をとって文字コード番号の合計に加算させる
let nowDate = new Date(); 
const dayCount = nowDate.getDate();
...
function assessment(userName){
  ...
  // 文字のコード番号の合計と日付の数字を回答の数で割って添字の数値を求める
  const index = (dayCount + sumOfCharCode) % answers.length;
